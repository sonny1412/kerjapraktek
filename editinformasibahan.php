...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="informasibahan.html"><i class="fa fa-circle-o"></i> Informasi Bahan</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="informasigudang.html"><i class="fa fa-circle-o"></i> Informasi Gudang</a></li>
            <li><a href="editgudang.html"><i class="fa fa-circle-o"></i> Edit Gudang</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li> <a href="tambahkaryawan.html"><i class="fa fa-table"></i> Tambah Karyawan</a></li>
            <li><a href="informasikaryawan.html"><i class="fa fa-circle-o"></i> Informasi karyawan</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <?php 
        require 'db.php';
        $var = $_GET['var'];
        $sql = "select * from barang where idBarang=".$var;
...
?>
<form action="manage.php?act=ubahbahan" method="POST" style="margin-left: 5%;" >
            Nama : <input type="text" name="nama" value="<?php echo $row->namaBarang;?>"><br/>
            Kuantitas : <input type="text" name="kuantitas" value="<?php echo $row->quantity;?>"><br/>
            ...
            Satuan : <input type="text" name="keterangan" value="<?php echo $row->keterangan;?>">
