...
<head>
  ...
  <link rel="stylesheet" href="css/css_regis/styledaftar.css">
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    ?> 
        <div id="wrapper-daftar">
        <form action="manage.php?act=insertbahan" method="POST">

            Nama : <input type="text" name="nama"><br/>
            Kuantitas : <input type="number" name="kuantitas"> 
            Satuan : <input type="text" name="keterangan"><br/>
