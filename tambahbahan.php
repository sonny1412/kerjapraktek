  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        if($jabatan == "Gudang" || $jabatan == "Pemilik"){
          echo "<li class=active><a href=tambahbahan.php><i class='fa fa-circle-o'></i> Tambah Bahan</a></li>";
        }
        if($jabatan == "Gudang" || $jabatan == "Pemilik" ||$jabatan == "Pembelian" || $jabatan == "Penjualan"){
          echo "</ul>
          </li>";
          ...
          <div class="box" style="width: 50%; margin: auto; margin-top: 5%">
            ...
            <fieldset>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputJumlahBahan" class="col-sm-2 control-label">Satuan</label>
            ...
            <fieldset>
              <legend style="text-align: center;">Masukan Kategori Bahan Baru</legend>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="hidden" name="jenis" value="Bahan Produksi">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
