      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        if($jabatan == "Pembelian" || $jabatan == "Pemilik"){
          ...
          <ul class=treeview-menu>
            ...
            <li class=active><a href=tambahsupplier.php><i class='fa fa-circle-o'></i> Tambah Supplier</a></li>
        ...
        if($jabatan == "Penjualan" || $jabatan == "Pemilik"){
          ...
          <ul class=treeview-menu>
            <li><a href=informasicutomer.php><i class='fa fa-circle-o'></i> Informasi Customer</a></li>
